...
import { Eye, EyeOff, User, Mail, Lock, BookMarked, ArrowRight, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-dark-800 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-accent-teal/10 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary-700/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="glass rounded-3xl p-8">
          <div className="mb-6">
            ...
            <p className="text-dark-300 text-sm mt-1">Start saving your bookmarks today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-dark-200 text-xs font-medium mb-1.5 block">Full Name</label>
